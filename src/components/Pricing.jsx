  ...
  return (
    <div className="my-30 space-y-10 container mx-auto">
      ...
      <div className="grid grid-cols-1 p-4 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-10">
        <div className="card h-112 bg-base-100 shadow-sm border border-gray-100">
          <div className="card-body">
            ...
            <div className="mt-auto">
              <button className="btn btn-primary btn-block font-bold rounded-full bg-linear-to-r from-indigo-600 to-purple-600 text-white">
                Get Started Free
              </button>
            </div>
          </div>
        ...
        <div className="card bg-base-100 shadow-sm border border-gray-100 bg-linear-to-r from-indigo-600 to-purple-600 relative text-white">
          <div className="w-[87px] h-[19px] bg-amber-100 rounded-3xl text-amber-500 text-xs flex items-center justify-center absolute top-[-10px] self-center">
            Most Popular
          </div>
          <div className="card-body">
            <div className="">
            ...
            <div className="mt-auto">
              <button
                className="btn btn-outline bg-white font-bold w-full p-px rounded-full"
                href="#"
              >
